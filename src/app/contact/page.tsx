  ...
  return (
    <main id="contact" className="container mx-auto mt-32 pt-6 md:pt-44">
      <div>
        ...
        <div className="mt-10 grid grid-cols-1 gap-x-8 gap-y-24 sm:mt-24 lg:mt-32 lg:grid-cols-5 xl:grid-cols-2">
          <section className="w-full lg:order-last lg:col-span-3  xl:col-span-1">
            <ContactForm />
          </section>
